...
const TRANSLATIONS = {
  ...
  zh_CN: {
    ...
    apiProviderHint: '选择 AI 服务提供商',
    apiTypeDesc: 'OpenAI 兼容接口或 Anthropic 格式',
    apiBaseUrlHint2: 'API 接口地址',
    apiKeyHint: '输入你的 API Key',
    apiModelHint2: '选择或输入模型名称',
    testApiDesc: '验证 API Key 和接口是否可用',
    languageDesc: '界面语言',
    darkModeDesc: '使用深色主题',
    maxRoundsDesc2: '超出限制的早期消息将被自动裁剪',
    ...
    groupButtons: '按钮',    defaultSummarizeLabel: '📝 总结全文',
  ...
  en: {
    ...
    apiProviderHint: 'Choose your AI provider',
    apiTypeDesc: 'OpenAI-compatible or Anthropic format',
    apiBaseUrlHint2: 'API endpoint address',
    apiKeyHint: 'Enter your API key',
    apiModelHint2: 'Select or enter model name',
    testApiDesc: 'Verify API key and endpoint',
    languageDesc: 'Interface language',
    darkModeDesc: 'Use dark theme',
    maxRoundsDesc2: 'Older messages beyond this limit will be trimmed',
    ...
    groupButtons: 'BUTTONS',    defaultSummarizeLabel: '📝 Summarize',
  ...
  ja: {
    ...
    apiProviderHint: 'AIプロバイダーを選択',
    apiTypeDesc: 'OpenAI互換またはAnthropic形式',
    apiBaseUrlHint2: 'APIエンドポイントアドレス',
    apiKeyHint: 'APIキーを入力',
    apiModelHint2: 'モデル名を選択または入力',
    testApiDesc: 'APIキーとエンドポイントを確認',
    languageDesc: 'インターフェース言語',
    darkModeDesc: 'ダークテーマを使用',
    maxRoundsDesc2: '制限を超えた古いメッセージは自動的に削除されます',
    ...
    groupConnection: '接続',
    groupEndpoint: 'エンドポイント',
    groupLanguage: '言語',
    groupTheme: 'テーマ',
    groupConversation: '会話',
    groupButtons: 'ボタン',    defaultSummarizeLabel: '📝 要約',
  ...
  zh_TW: {
    ...
    apiProviderHint: '選擇 AI 服務提供商',
    apiTypeDesc: 'OpenAI 兼容接口或 Anthropic 格式',
    apiBaseUrlHint2: 'API 接口地址',
    apiKeyHint: '輸入你的 API Key',
    apiModelHint2: '選擇或輸入模型名稱',
    testApiDesc: '驗證 API Key 和接口是否可用',
    languageDesc: '界面語言',
    darkModeDesc: '使用深色主題',
    maxRoundsDesc2: '超出限制的早期消息將被自動裁剪',
    ...
    groupButtons: '按鈕',    defaultSummarizeLabel: '📝 總結全文',
  ...
  ko: {
    ...
    apiProviderHint: 'AI 제공자를 선택하세요',
    apiTypeDesc: 'OpenAI 호환 또는 Anthropic 형식',
    apiBaseUrlHint2: 'API 엔드포인트 주소',
    apiKeyHint: 'API 키 입력',
    apiModelHint2: '모델 이름 선택 또는 입력',
    testApiDesc: 'API 키와 엔드포인트 확인',
    languageDesc: '인터페이스 언어',
    darkModeDesc: '다크 테마 사용',
    maxRoundsDesc2: '제한을 초과하는 이전 메시지가 자동으로 정리됩니다',

    sectionConfig: '설정',
    sectionApi: 'API',
    sectionQuick: '빠른 작업',
    sectionPreferences: '환경 설정',
    ...
    groupButtons: '버튼',    defaultSummarizeLabel: '📝 요약',
  ...
  es: {
    ...
    apiProviderHint: 'Elige tu proveedor de IA',
    apiTypeDesc: 'Compatible con OpenAI o formato Anthropic',
    apiBaseUrlHint2: 'Dirección del endpoint API',
    apiKeyHint: 'Introduce tu clave API',
    apiModelHint2: 'Selecciona o introduce el modelo',
    testApiDesc: 'Verificar clave API y endpoint',
    languageDesc: 'Idioma de la interfaz',
    darkModeDesc: 'Usar tema oscuro',
    maxRoundsDesc2: 'Los mensajes antiguos que superen el límite se recortarán',

    sectionConfig: 'CONFIGURACIÓN',
    sectionApi: 'API',
    sectionQuick: 'Acciones rápidas',
    ...
    groupButtons: 'BOTONES',    defaultSummarizePrompt: 'Por favor, resume el contenido principal de esta página web en español',
  ...
  fr: {
    ...
    testApiLabel: 'Tester la connexion',
    ...
    apiProviderHint: 'Choisissez votre fournisseur d\'IA',
    apiTypeDesc: 'Compatible OpenAI ou format Anthropic',
    apiBaseUrlHint2: 'Adresse du point de terminaison API',
    apiKeyHint: 'Entrez votre clé API',
    apiModelHint2: 'Sélectionnez ou saisissez le modèle',
    testApiDesc: 'Vérifier la clé API et le point de terminaison',
    languageDesc: 'Langue de l\'interface',
    darkModeDesc: 'Utiliser le thème sombre',
    maxRoundsDesc2: 'Les messages anciens au-delà de cette limite seront supprimés',

    sectionConfig: 'CONFIGURATION',
    sectionApi: 'API',
    sectionQuick: 'Actions rapides',
    ...
    groupTheme: 'THÈME',
    groupConversation: 'CONVERSATION',
    groupButtons: 'BOUTONS',    defaultSummarizePrompt: 'Veuillez résumer le contenu principal de cette page web en français',
  ...
  de: {
    ...
    apiTypeLabel: 'API-Format',
    testApiLabel: 'Verbindung testen',
    ...
    apiProviderHint: 'Wählen Sie Ihren KI-Anbieter',
    apiTypeDesc: 'OpenAI-kompatibel oder Anthropic-Format',
    apiBaseUrlHint2: 'API-Endpunktadresse',
    apiKeyHint: 'API-Schlüssel eingeben',
    apiModelHint2: 'Modell auswählen oder eingeben',
    testApiDesc: 'API-Schlüssel und Endpunkt überprüfen',
    languageDesc: 'Oberflächensprache',
    darkModeDesc: 'Dunkles Thema verwenden',
    maxRoundsDesc2: 'Ältere Nachrichten über diesem Limit werden gekürzt',

    sectionConfig: 'KONFIGURATION',
    sectionApi: 'API',
    sectionQuick: 'Schnellaktionen',
    sectionPreferences: 'EINSTELLUNGEN',
    sectionAppearance: 'Darstellung',
    groupConnection: 'VERBINDUNG',
    groupEndpoint: 'ENDPUNKT',
    groupLanguage: 'SPRACHE',
    groupTheme: 'THEMA',
    groupConversation: 'GESPRÄCH',
    groupButtons: 'SCHALTFLÄCHEN',    defaultSummarizePrompt: 'Bitte fasse den Kerninhalt dieser Webseite auf Deutsch zusammen',
  ...
  ru: {
    ...
    testApiLabel: 'Проверить соединение',
    ...
    apiProviderHint: 'Выберите поставщика ИИ',
    apiTypeDesc: 'Совместимый с OpenAI или формат Anthropic',
    apiBaseUrlHint2: 'Адрес конечной точки API',
    apiKeyHint: 'Введите ваш ключ API',
    apiModelHint2: 'Выберите или введите модель',
    testApiDesc: 'Проверить ключ API и конечную точку',
    languageDesc: 'Язык интерфейса',
    darkModeDesc: 'Использовать темную тему',
    maxRoundsDesc2: 'Старые сообщения сверх лимита будут обрезаны',

    sectionConfig: 'КОНФИГУРАЦИЯ',
    sectionApi: 'API',
    sectionQuick: 'Быстрые действия',
    ...
    groupButtons: 'КНОПКИ',    defaultSummarizePrompt: 'Пожалуйста, резюмируйте основное содержание этой веб-страницы на русском языке',
  ...
  vi: {
    ...
    apiProviderHint: 'Chọn nhà cung cấp AI',
    apiTypeDesc: 'Tương thích OpenAI hoặc định dạng Anthropic',
    apiBaseUrlHint2: 'Địa chỉ endpoint API',
    apiKeyHint: 'Nhập API Key',
    apiModelHint2: 'Chọn hoặc nhập tên mô hình',
    testApiDesc: 'Xác minh API Key và endpoint',
    languageDesc: 'Ngôn ngữ giao diện',
    darkModeDesc: 'Sử dụng giao diện tối',
    maxRoundsDesc2: 'Các tin nhắn cũ vượt quá giới hạn sẽ bị cắt',

    sectionConfig: 'CẤU HÌNH',
    sectionApi: 'API',
    sectionQuick: 'Thao tác nhanh',
    sectionPreferences: 'TÙY CHỈNH',
    sectionAppearance: 'Giao diện',
    groupConnection: 'KẾT NỐI',
    groupEndpoint: 'ENDPOINT',
    groupLanguage: 'NGÔN NGỮ',
    groupTheme: 'GIAO DIỆN',
    groupConversation: 'HỘI THOẠI',
    groupButtons: 'NÚT',    defaultSummarizePrompt: 'Vui lòng tóm tắt nội dung chính của trang web này bằng tiếng Việt',
