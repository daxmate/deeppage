...
function injectStyles() {
  ...
  style.textContent = `
    ...
    #__dp-dark-toggle svg { display: block; }
...
function createChatPanel() {
  ...
  panel.innerHTML = `
    <div id="__dp-panel-header">
      ...
      <button id="__dp-history-btn" title="${t('historyButton') || 'History'}"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg></button>
